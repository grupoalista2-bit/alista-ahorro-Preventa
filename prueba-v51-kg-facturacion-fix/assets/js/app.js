...
function normalizePedidoItemPrecio(it,catalogo){
  ...
  // V51: si el artículo del catálogo está marcado como pesable, el pedido/preparación
  // también debe permitir decimales por kg aunque el pedido haya sido creado antes.
  if(art && art.pesable)x.pesable=true;
  return x;
}
